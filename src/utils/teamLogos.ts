...
export const TEAM_LOGOS: Record<string, string> = {
  ...
  'Chapecoense-sc': 'https://logodetimes.com/times/chapecoense/logo-chapecoense-256.png',
  ...
  'America Mineiro': 'https://logodetimes.com/times/america-mineiro/logo-america-mineiro-256.png',
  ...
  'Uniao Trabalhadores': 'https://logodetimes.com/times/uniao-trabalhadores/logo-uniao-trabalhadores-256.png',
  'North Esporte': 'https://logodetimes.com/times/north-esporte/logo-north-esporte-256.png',
  'Betim': 'https://logodetimes.com/times/betim/logo-betim-256.png',
...
export const TEAM_COLORS: Record<string, { primary: string; secondary: string }> = {
  ...
  'Red Bull Bragantino-sc': { primary: '#D1001C', secondary: '#FFFFFF' },
  'RB Bragantino': { primary: '#D1001C', secondary: '#FFFFFF' },
  'Athletico-PR': { primary: '#D50032', secondary: '#000000' },
  'Athletico Paranaense': { primary: '#D50032', secondary: '#000000' },
  ...
  'America Mineiro': { primary: '#008C3A', secondary: '#FFFFFF' },
  ...
  'Chapecoense-sc': { primary: '#009145', secondary: '#FFFFFF' },
  ...
  'Uniao Trabalhadores': { primary: '#000080', secondary: '#FFFFFF' },
  'North Esporte': { primary: '#000080', secondary: '#FFFFFF' },
  'Betim': { primary: '#161923', secondary: '#FFFFFF' },
