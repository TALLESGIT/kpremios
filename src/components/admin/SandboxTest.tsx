...
const SandboxTest: React.FC = () => {
  ...
  const sendTestMessage = async () => {
    ...
    try {
      console.log('🚀 Enviando mensagem via Vonage Sandbox...');
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">🚀 Teste Vonage Sandbox</h2>
          <p className="text-gray-600">Teste o sistema WhatsApp via Vonage</p>
        </div>
        <div className="bg-blue-100 border border-blue-200 rounded-md p-3">
          ...
          <p className="text-sm text-blue-700">
            ...
            <strong>Sandbox:</strong> Ativo<br/>
      ...
      <div className="mt-6 bg-gray-50 border border-gray-200 rounded-md p-4">
        <h4 className="font-medium text-gray-800 mb-2">📋 Informações do Sandbox:</h4>
        <ul className="text-sm text-gray-700 space-y-1">
          <li><strong>Provider:</strong> Vonage (ex-Nexmo)</li>
          <li><strong>Sandbox:</strong> sled click Messages API Sandbox</li>
          <li><strong>Número Sandbox:</strong> +14157386102</li>
          <li><strong>Seu Número:</strong> +5533999030124</li>
          <li><strong>Status:</strong> Configurado e ativo</li>
        </ul>
      </div>
    </div>
  );
