        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl max-h-[85vh] bg-slate-900 rounded-[2.5rem] border border-white/10 overflow-hidden shadow-2xl flex flex-col"
            >
              {/* Modal Header - Fixed */}
              <div className="flex items-center justify-between p-5 md:p-6 border-b border-white/5 bg-slate-900/50 backdrop-blur-md shrink-0">
                ...
                <button onClick={() => setIsModalOpen(false)} className="p-2 bg-white/5 hover:bg-white/10 rounded-xl text-slate-400 transition-all">
                  <X className="w-5 h-5" />
                </button>
              </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full px-5 py-3.5 bg-white/5 border border-white/10 rounded-2xl text-white font-medium focus:outline-none focus:border-blue-500/50 transition-all text-sm"
                    ...
                    <div className="grid grid-cols-2 gap-6 md:col-span-2">
                      <div className="space-y-1.5">
                        ...
                        <input
                          ...
                          className="w-full px-5 py-2.5 bg-white/5 border border-white/10 rounded-2xl text-white font-medium focus:outline-none focus:border-blue-500/50 transition-all text-sm"
                          placeholder="0.00"
                        />
                      </div>
                      <div className="space-y-1.5">
                    ...
                    <div className="md:col-span-2 space-y-3 pt-3 border-t border-white/5">
                      ...
                      <div className="flex flex-col gap-2">
                        <input
                          ...
                          className="w-full px-5 py-2.5 bg-white/5 border border-white/10 rounded-2xl text-white font-medium focus:outline-none focus:border-blue-500/50 transition-all text-xs"
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              ...
                              className="flex items-center gap-2 text-[9px] font-black text-emerald-400 hover:text-emerald-300 transition-colors"
                            >
                            ...
                            {formData.gallery_urls.map((url, index) => (
                              <div key={index} className="flex gap-2">
                                <input
                                  ...
                                  className="flex-1 px-4 py-1.5 bg-white/5 border border-white/10 rounded-xl text-white text-[10px] focus:outline-none"
                                  placeholder="URL da foto"
                                />
                                <button
                                  type="button"
                                  onClick={() => setFormData({ ...formData, gallery_urls: formData.gallery_urls.filter((_, i) => i !== index) })}
                    ...
                    <div className="md:col-span-2 grid grid-cols-2 gap-3 p-4 bg-slate-800/20 rounded-3xl border border-white/5">
                      <div className="flex items-center justify-between px-2">
                        <div className="space-y-0.5">
                          <p className="text-white font-bold text-[11px] uppercase italic">Disponível</p>
                          <p className="text-[9px] text-slate-500 uppercase font-medium">Visível na loja</p>
                        </div>
                        <button
                          type="button"
                          onClick={() => setFormData({ ...formData, is_available: !formData.is_available })}
                          className={`w-10 h-5 rounded-full transition-all relative ${formData.is_available ? 'bg-emerald-500' : 'bg-slate-700'}`}
                        >
                          <div className={`absolute top-0.5 w-4 h-4 bg-white rounded-full transition-all ${formData.is_available ? 'right-0.5' : 'left-0.5'}`} />
                        </button>
                      </div>

                      <div className="flex items-center justify-between px-2">
                        <div className="space-y-0.5">
                          <p className="text-white font-bold text-[11px] uppercase italic">Em Breve</p>
                          <p className="text-[9px] text-slate-500 uppercase font-medium">Selo "Coming Soon"</p>
                        </div>
                        <button
                          type="button"
                    ...
                    <div className="md:col-span-2 space-y-3 pt-3 border-t border-white/5">
                      ...
                      <div className="grid grid-cols-4 gap-3">
                        ...
                        <div className="space-y-1">
                          <label className="text-[8px] font-black text-slate-500 uppercase tracking-widest ml-2">Largura</label>
                          <input
                            type="number"
                        ...
                        <div className="space-y-1">
                          <label className="text-[8px] font-black text-slate-500 uppercase tracking-widest ml-2">Altura</label>
                          <input
                            type="number"
                        ...
                        <div className="space-y-1">
                          <label className="text-[8px] font-black text-slate-500 uppercase tracking-widest ml-2">Compr.</label>
                          <input
                            type="number"
                      ...
                      <div className="flex flex-col gap-3 p-4 bg-amber-600/5 rounded-3xl border-amber-500/10">
                        <div className="flex items-center justify-between">
                          <div className="space-y-0.5">
                            ...
                            <p className="text-[9px] text-slate-500 uppercase">Todo o Brasil</p>
                          </div>
                          <button
                            type="button"
                            onClick={() => setFormData({ ...formData, is_free_shipping: !formData.is_free_shipping })}
                            className={`w-10 h-5 rounded-full transition-all relative ${formData.is_free_shipping ? 'bg-emerald-500' : 'bg-slate-700'}`}
                          >
                            <div className={`absolute top-0.5 w-4 h-4 bg-white rounded-full transition-all ${formData.is_free_shipping ? 'right-0.5' : 'left-0.5'}`} />
                          </button>
                        </div>
              ...
              {/* Modal Footer - Fixed */}
              <div className="p-4 md:p-6 border-t border-white/5 bg-slate-900 shrink-0">
                <button
                  form="product-form"
                  disabled={isSaving}
