...
export const ViewerCountDisplay: React.FC<ViewerCountDisplayProps> = ({
  ...
  return (
    <div className={`inline-flex items-center gap-2.5 px-4 py-2 bg-slate-900/40 backdrop-blur-md border border-white/10 rounded-2xl shadow-xl ${isTVMode ? 'scale-125 origin-top-left -translate-y-2' : ''} ${className}`}>
