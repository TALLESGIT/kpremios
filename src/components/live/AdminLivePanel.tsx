...
import { Users, MessageSquare, Eye, TrendingUp, Clock, Copy, Share2, Crown } from 'lucide-react';
...
const AdminLivePanel: React.FC<AdminLivePanelProps> = ({ streamId, channelName, isActive }) => {
  ...
  const [vipTestName, setVipTestName] = useState('Novo Usuário VIP');
    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between gap-4 mb-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-2xl font-black text-white uppercase italic">Painel de Controle</h3>
