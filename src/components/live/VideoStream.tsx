            ...
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex flex-col gap-3 z-20">
              ...
              <div className="flex gap-2 justify-center">
                ...
                <button
                  ...
                  title={showCamera ? 'Desativar câmera' : 'Ativar câmera (PiP)'}
                >
                  <Video size={16} className="inline mr-1" />
                  {showCamera ? 'Câmera ON' : 'Câmera OFF'}
                </button>
              </div>
                ...
                <div className="bg-gray-800 p-3 rounded-lg space-y-2">
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="URL direta do vídeo (.mp4, .webm, .m3u8)"
                      ...
                      onKeyPress={(e) => {
                        if (e.key === 'Enter' && externalVideoUrl) {
                          switchVideoSource('external', externalVideoUrl);
                  ...
                  <p className="text-xs text-gray-400">
                    💡 <strong>Dica:</strong> Use URLs diretas de vídeo (.mp4, .webm) ou streams HLS (.m3u8). 
                    Para YouTube/Twitch, use "Compartilhar Tela" e abra o vídeo em outra aba.
                  </p>
                </div>
              )}
