      ...
      <AnimatePresence>
        {alerts.map((alert) => (
          ...
          >
            ...
            {/* Main Premium Card */}
            <div className="relative flex items-center gap-1.5 sm:gap-4 px-2 sm:px-6 py-1.5 sm:py-4 bg-slate-950/95 backdrop-blur-2xl rounded-lg sm:rounded-[1.5rem] border border-yellow-500/50 shadow-2xl overflow-hidden min-w-[140px] sm:min-w-[280px]">
              ...
              <div className="relative flex-shrink-0">
                ...
                <motion.div
                  ...
                  className="relative p-1.5 sm:p-3 bg-gradient-to-br from-yellow-400 to-amber-600 rounded-lg sm:rounded-2xl shadow-lg ring-1 ring-yellow-300/50"
                >
                  <Crown className="w-4 h-4 sm:w-7 sm:h-7 text-slate-950 fill-slate-900" strokeWidth={2.5} />
                </motion.div>
              ...
              <div className="flex flex-col">
                ...
                <h3 className="text-sm sm:text-2xl font-black text-white italic tracking-tight drop-shadow-[0_2px_4px_rgba(255,255,255,0.1)] uppercase leading-none">
                  {alert.user_name}
                </h3>
              </div>
