    ...
    try {
      ...
      if (data && data.length > 0) {
        data = data.filter((bet: any) => {
          ...
          const resultDate = pool.result_set_at || pool.updated_at;
    ...
    <div className="min-h-screen flex flex-col bg-slate-900">
      ...
      <main className="flex-grow w-full relative overflow-hidden">
        ...
        <div className="fixed inset-0 pointer-events-none">
          <div className="absolute top-0 left-0 w-full h-[500px] bg-amber-500/10 blur-[100px]" />
          <div className="absolute bottom-0 right-0 w-full h-[500px] bg-slate-700/20 blur-[100px]" />
        ...
        <div className="relative py-12 sm:py-20 lg:py-24">
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="inline-flex p-4 rounded-3xl bg-amber-500/10 mb-6 ring-1 ring-amber-400/20 backdrop-blur-md shadow-2xl shadow-amber-500/10">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-6 tracking-tight">
              GALERIA DE <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-200">GANHADORES</span>
            </h1>

            <p className="text-lg sm:text-xl text-slate-300/80 max-w-2xl mx-auto font-medium leading-relaxed">
            ...
            {poolsArray.map((group: any) => {
              ...
              return (
                <div key={pool.id} className="glass-panel rounded-3xl overflow-hidden border border-emerald-500/20 bg-slate-800/40 backdrop-blur-md">
                  {/* Cabeçalho do Jogo */}
                  <div className="relative bg-gradient-to-r from-amber-600/20 to-amber-700/20 p-6 border-b border-amber-500/30">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div className="flex items-center justify-between sm:col-span-2">
                        <div className="text-center flex-1">
                          ...
                          <p className="text-3xl font-black text-amber-400">{pool.result_home_score}</p>
                        </div>
                        <span className="text-amber-400 font-black text-2xl mx-3">x</span>
                        <div className="text-center flex-1">
                          <p className="text-xs font-medium text-slate-300 mb-2">{pool.away_team}</p>
                          <p className="text-3xl font-black text-amber-400">{pool.result_away_score}</p>
                        </div>
                      </div>

                      <div className="flex flex-col items-center sm:items-end justify-center gap-2 pt-4 sm:pt-0 border-t sm:border-t-0 sm:border-l border-amber-500/20 sm:pl-4">
        ...
        {poolWinners.length === 0 && (
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
            <div className="glass-panel p-12 sm:p-16 rounded-3xl text-center max-w-2xl mx-auto border border-white/5 bg-slate-800/50 backdrop-blur-xl">
              ...
              <p className="text-slate-400/60 max-w-md mx-auto text-base sm:text-lg mb-8">
                {activePool 
              ...
              <button
                ...
                className="inline-flex items-center justify-center px-8 py-4 text-base font-bold text-white transition-all duration-200 bg-gradient-to-r from-amber-600 to-amber-500 rounded-2xl hover:from-amber-500 hover:to-amber-400 hover:shadow-lg hover:shadow-amber-500/25"
              >
