            ...
            <div className="p-8 bg-black/20 backdrop-blur-md">
              <form onSubmit={isLoginMode ? handleLogin : handleRegister} className="space-y-5">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-accent to-accent/90 hover:from-accent hover:to-accent text-primary font-black py-4 rounded-xl flex items-center justify-center gap-2 group shadow-lg shadow-accent/20 hover:shadow-accent/40 active:scale-95 transition-all mt-4"
                >
                  {loading ? (
                    <>
